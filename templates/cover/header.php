<?php
/**
 * Template view: cover (type_id=3, "Bài L2" / cover-story) — bài bìa: cover trên, text center dưới.
 * Port 1:1 từ frontsite views/components/post-header-cover-story.php.
 *
 * Cấu trúc: [cover-top nếu có] + inner (kicker/topic/headline/byline-có-sep/excerpt).
 * Inner identical longform-default (topic img ESCAPE). Khác standard/longform: thêm cover-top.
 * Cover src dùng VARIANT_COVER (gốc resizeImageUrl(cover, 0)), escape ENT_QUOTES.
 *
